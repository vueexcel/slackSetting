      ...
      <b-col md="12">
        <Widget customHeader>
          ...
          >
            ...
            <div>
              <button type="button" class="m-1 btn btn-outline-primary">Approve</button>
              <button type="button" class="m-1 btn btn-outline-danger">Reject</button>
            </div>
            <div class="mt-4" v-if="msg.message_type === 'complex_message'">
              <b-form-group label="Slack Channels" v-if="false">
                <b-form-input
      ...
      this.api_slackMessage()
        .then(res => {
          res.data.forEach((element, index) => {
            ...
            // setting selected slack channel
